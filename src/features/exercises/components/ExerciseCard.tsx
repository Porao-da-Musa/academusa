      ...
      <div data-testid="exercise-card">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-900" data-testid="exercise-category">
              {exercise.category}
            </span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span className="text-gray-500">Equipamento:</span>
            <span className="text-gray-900" data-testid="exercise-equipment">
              {exercise.equipment}
            </span>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            <span
              className={`px-2 py-1 rounded text-xs font-medium ${levelStyles.bg} ${levelStyles.text}`}
            >
              {exercise.level}
            </span>
          </div>
